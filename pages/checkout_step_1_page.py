...
class CheckoutStep1Page(BasePage):
    ...
    def enter_name(self, name):
        self.get_input_frame(CheckoutStep1PageLocators.FIRST_NAME_LOCATOR).send_keys(name)

    def enter_last_name(self, last_name):
        self.get_input_frame(CheckoutStep1PageLocators.LAST_NAME_LOCATOR).send_keys(last_name)

    def enter_zip_code(self, zip_code):
        self.get_input_frame(CheckoutStep1PageLocators.ZIP_CODE_LOCATOR).send_keys(zip_code)

    def click_continue(self):
        self.driver.find_element(*CheckoutStep1PageLocators.CONTINUE_LOCATOR).click()
